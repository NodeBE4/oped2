...
<article class="post-16250 post type-post status-publish format-standard has-post-thumbnail hentry category-knowledge-node category-45 category-32 category-67 category-33 tag-activism tag-direct-action tag-informationactivism tag-social-movement tag-storytelling tag-technique tag-tools" id="post-16250">
 ...
 <div class="entry-content">
  ...
  <p class="graf graf--p">
   视频以一系列关于政府进攻的图片开场。用一系列标题卡回顾了这次行动的
   <strong class="markup--strong markup--p-strong">
    事实，包括有多少人流离失所
   </strong>
  ...
  <p class="graf graf--p">
   <a class="markup--anchor markup--p-anchor" data-href="https://www.lwks.com/" href="https://www.lwks.com/" rel="noopener" target="_blank">
    Lightworks
   </a>
  ...
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
    ...
    <a class="markup--anchor markup--p-anchor" data-href="http://www.youtube.com/editor" href="https://www.youtube.com/editor" rel="noopener" style="color: #ff99cc;" target="_blank">
     <strong class="markup--strong markup--p-strong">
      Online video editors
     </strong>
    </a>
  ...
  <figure class="graf graf--figure">
   ...
   <noscript>
    <img class="graf-image aligncenter" data-height="500" data-image-id="0*BEUMoy_QO-qPzmo8.png" data-recalc-dims="1" data-width="1024" src="https://i0.wp.com/cdn-images-1.medium.com/max/1067/0*BEUMoy_QO-qPzmo8.png?w=1100&amp;ssl=1"/>
   </noscript>
  </figure>
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
  ...
  <p class="graf graf--p">
   第二段视频是对叙利亚总统巴沙尔·阿萨德的妻子阿斯玛（Asma）的采访进行了重新剪辑。阿斯玛·阿萨德在采访中对加沙的杀戮表示愤慨，
   <strong class="markup--strong markup--p-strong">
  ...
  <p class="graf graf--p">
   加速和减慢镜头也会极大地影响观众对镜头的看法。放慢镜头可以给人一种深思熟虑的感觉，而加快镜头则会让人觉得滑稽或疯狂。
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff6600;">
    <strong class="markup--strong markup--p-strong">
  ...
  <p class="graf graf--p">
   总部设在孟买的非政府组织 “Breakthrough” 策划了 “Bell Bajao” 运动，以动员男子站出来反对家庭暴力。
  </p>
  <p class="graf graf--p">
  ...
  <p class="graf graf--p">
   ZA新闻是一个讽刺性的网络电视节目，嘲笑南非的政客和时事。2009年首次播出，其形式是一档新闻节目，看起来和听起来都非常像官方媒体南非广播公司（SABC）。委托试播后，SABC拒绝播出。之后该节目在网上播放，覆盖了南非10%能够上网的人口。
  </p>
  <p class="graf graf--p">
  ...
  <p class="graf graf--p">
   ...
   是摄影师工作的重要组成部分。一定要尊重您的拍摄对象和环境。
  </p>
  <p class="graf graf--p">
   将照片转移到电脑后，仔细查看，删除模糊或无法使用的照片，并将照片组进行整理或标记，方便日后参考。
  </p>
  <p class="graf graf--p">
   将重要的照片至少存放在两个不同的地方，作为备份。
  </p>
  <p class="graf graf--p">
   要注意您在照片上留下的
   ...
   ，任何人都能够读取这些信息。当处理敏感话题时，一定要在将照片发布到网上之前清理掉任何元数据。
   <strong class="markup--strong markup--p-strong">
    具体操作方法见这里
   </strong>
   《
  ...
  <figure class="graf graf--figure">
   <img class="graf-image aligncenter jetpack-lazy-image" data-height="938" data-image-id="1*qtdIYOXv1G02-dGM6RBC5Q.png" data-lazy-src="https://i1.wp.com/cdn-images-1.medium.com/max/1067/1*qtdIYOXv1G02-dGM6RBC5Q.png?w=1100&amp;is-pending-load=1#038;ssl=1" data-recalc-dims="1" data-width="938" src="https://i1.wp.com/cdn-images-1.medium.com/max/1067/1*qtdIYOXv1G02-dGM6RBC5Q.png?w=1100&amp;ssl=1" srcset="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"/>
   <noscript>
    <img class="graf-image aligncenter" data-height="938" data-image-id="1*qtdIYOXv1G02-dGM6RBC5Q.png" data-recalc-dims="1" data-width="938" src="https://i1.wp.com/cdn-images-1.medium.com/max/1067/1*qtdIYOXv1G02-dGM6RBC5Q.png?w=1100&amp;ssl=1"/>
   </noscript>
  </figure>
  <h3 class="graf graf--p">
   <span style="color: #ff6600;">
  ...
  <p class="graf graf--p">
   想一想您的内容会是什么格式。您想要简洁的信息吗？还是更长、更深入的文章？文章是否会经常更新？想清楚这一点将有助于您开发设计和选择适合您网站的模块。
  </p>
  <p class="graf graf--p">
   内容最重要。再多的小部件也无法弥补不充分或编辑不当的内容。
  </p>
  <p class="graf graf--p">
   尽早购买您的域名。使用WHOIS的查询服务来确定哪些域名仍然可用。
  </p>
  <p class="graf graf--p">
   在您开始建设之前，确保您的网站的组织结构已经规划好了。
   <strong class="markup--strong markup--p-strong">
    从用户的角度考虑
   </strong>
   ：内容是否容易找到？互联网用户的注意力是短暂的，浪费在寻找内容上的时间可能导致人们过快地离开您的网站。
  </p>
  <p class="graf graf--p">
   有多少用户会主动使用这个网站？您有多少贡献者、编辑和管理员？了解不同合作者需要什么样的访问权限，并相应地分配权限。
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff6600;">
    <strong class="markup--strong markup--p-strong">
  ...
  <p class="graf graf--p">
   ...
   。对于海报或抗议标志，原则是；少即是多。您需要一个有冲击力的标语和最重要的信息，用大字体以提高可见度。对于人们更愿意携带或阅读的讲义或传单，则以较长的文字为宜。
  </p>
  <p class="graf graf--p">
   <strong class="markup--strong markup--p-strong">
    集中
   ...
   。吸引眼球的图像、图形和排版都很重要，但如果信息不集中，就无法让人记忆深刻。
  </p>
  <p class="graf graf--p">
   始终
   <strong class="markup--strong markup--p-strong">
   ...
   您的文本。印刷品是一种物理媒介，不像网络媒体那样对错误或错字那么宽容。如果您要印刷大量的材料，请仔细校对您的文本! 考虑把它交给队友，让他们用新的眼光来审视。
  </p>
  <p class="graf graf--p">
   选择图片时要考虑印刷质量。如果您的图片是彩色的，而您要印刷的是黑白的，一定要把图片转换成黑白的，以确保图片在去掉颜色后仍能保持其想要的效果。还要确保您的印刷质量足够高，以保持黑白图像的色调对比。
  </p>
  <p class="graf graf--p">
   在设计海报时，要将形式与内容结合起来，思考信息的流动和眼睛在其中划过的路径。
   <strong class="markup--strong markup--p-strong">
    最重要的一块内容应该是最大的，其颜色和字体应该足够吸引眼球。目光会从上到下经过内容，在大多数语言中，眼睛会从左到右
   </strong>
   ；在阿拉伯语中，眼睛会从右到左；在某些情况下，如在日语中，眼睛从右到左和从左到右都有可能。
  </p>
  <p class="graf graf--p">
   不要总是相信屏幕。在制作最终的印刷品之前，一定要
   <strong class="markup--strong markup--p-strong">
    试印一份样张
   </strong>
   。这将使您能够检测到色彩和分辨率的变化，而这些变化不一定能在电脑显示器上看出来，即使是非常好的显示器。您可能需要调整亮度、对比度或颜色，也许图像在屏幕上看起来 “不合适”，但在印刷时却是合适的。
  </p>
  <p class="graf graf--p">
   印刷品的图像应
   <strong class="markup--strong markup--p-strong">
   ...
   。网络图像在屏幕上72dpi时看起来还算合格，但以更高的分辨率打印时就会显得像素化。对于印刷来说，低分辨率的图像很少能满足印刷的需要，高分辨率的图像是必须的。越高越好。另一方面，让您的网页图像在较低的分辨率下也不是一件坏事，它可以降低其文件大小，并使您的网站加载速度更快。
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff6600;">
    <strong class="markup--strong markup--p-strong">
  ...
  <p class="graf graf--p">
   在决定选择哪种形式时，要考虑您的目标、能力和受众。您是想让人们对某一问题迅速采取行动，还是您有一个本身就有意义且不会很快过时的信息？
   <strong class="markup--strong markup--p-strong">
    简单的信息可以采用较小的一次性格式
   </strong>
   ，如海报、贴纸和T恤，或者是小册子或传单，其中可以包括一个
   <strong class="markup--strong markup--p-strong">
    链接到您的网站上
   </strong>
   ，以帮助受众跟随更频繁的更新。海报或贴纸可以由志愿者张贴，传单可以在示威活动中分发。
  </p>
  <p class="graf graf--p">
   如果您想通过让人们深入了解您的事业所涉及的问题来长期吸引他们，或者如果您的信息一直在变化，并且与其他发展相关，那么最好的办法是发行通讯或杂志。
  </p>
  <p class="graf graf--p">
   为了突出某个特定的主题，您可以发行一次性的出版物，如简报或公报  — — 但不要告诉您的听众它将成为一个系列的一部分，除非您致力于制作更多的内容。
  </p>
  <p class="graf graf--p">
   一个较长的文本可能需要作为报告甚至作为一本书出版。如果您的预算较少，它可以成为电子书供下载，
   <a class="markup--anchor markup--p-anchor" data-href="https://www.iyouport.org/%e5%a6%82%e4%bd%95%e4%bb%a5%e6%9c%80%e4%bd%8e%e6%88%90%e6%9c%ac%e5%bf%ab%e9%80%9f%e5%87%ba%e7%89%88%e8%87%aa%e5%b7%b1%e7%9a%84%e7%94%b5%e5%ad%90%e4%b9%a6%ef%bc%9f/" href="https://www.iyouport.org/%e5%a6%82%e4%bd%95%e4%bb%a5%e6%9c%80%e4%bd%8e%e6%88%90%e6%9c%ac%e5%bf%ab%e9%80%9f%e5%87%ba%e7%89%88%e8%87%aa%e5%b7%b1%e7%9a%84%e7%94%b5%e5%ad%90%e4%b9%a6%ef%bc%9f/" rel="noopener" target="_blank">
    在这里看到制作电子书的方法
   </a>
   。记住，任何在线出版的东西都可以更便宜、更容易地更新。
  </p>
  <p class="graf graf--p">
  ...
  <p class="graf graf--p">
   通读  — — 在进行任何修改之前，一定要通读整份文件。
  </p>
  <p class="graf graf--p">
   尊重贡献者 —— 无论您的组织是为了强调特定的目标而进行大量的编辑，还是为了支持作者的声音而进行简要编辑。
  </p>
  <p class="graf graf--p">
   提问题 —— 对任何修改都要有一个可靠的理由。当您不确定某件事情的含义时，要提出问题。
  </p>
  <p class="graf graf--p">
   一致性 — — 使用您的风格指南和常识来实现整体的一致性。
  </p>
  <p class="graf graf--p">
   谦虚 — — 节省时间并尊重他人，只修改为实现目标而必须修改的内容。
  </p>
  <p class="graf graf--p">
   事实检查 — — 谁对您发布的事实信息负责？您的签收程序是什么？信息是否准确和最新？留出时间进行核对。
  </p>
  <p class="graf graf--p">
   清晰度和可读性  — — 将长段和长句子打散。
   <strong class="markup--strong markup--p-strong">
    使用主动语态而不是被动语态。避免使用行话
   </strong>
   。
  </p>
  <p class="graf graf--p">
  ...
  <p class="graf graf--p">
   紧缩和削减 — — 消除多余的词语、过多的形容词和分散注意力的细节。修正含糊不清的语言和重复的内容。删去最不重要的信息，但保存原先的版本，以备您需要回溯和检索任何内容。
  </p>
  <figure class="graf graf--figure">
   <img class="graf-image aligncenter jetpack-lazy-image" data-height="1250" data-image-id="1*Kzy5MlPDUm1qy-KIZAx9Mw.png" data-lazy-src="https://i0.wp.com/cdn-images-1.medium.com/max/1067/1*Kzy5MlPDUm1qy-KIZAx9Mw.png?w=1100&amp;is-pending-load=1#038;ssl=1" data-recalc-dims="1" data-width="1246" src="https://i0.wp.com/cdn-images-1.medium.com/max/1067/1*Kzy5MlPDUm1qy-KIZAx9Mw.png?w=1100&amp;ssl=1" srcset="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"/>
   <noscript>
    <img class="graf-image aligncenter" data-height="1250" data-image-id="1*Kzy5MlPDUm1qy-KIZAx9Mw.png" data-recalc-dims="1" data-width="1246" src="https://i0.wp.com/cdn-images-1.medium.com/max/1067/1*Kzy5MlPDUm1qy-KIZAx9Mw.png?w=1100&amp;ssl=1"/>
   </noscript>
  </figure>
  <h3 class="graf graf--p">
   <span style="color: #ff6600;">
  ...
  <p class="graf graf--p">
   口碑是寻找有能力的合作伙伴的最佳途径。请您的朋友或同事推荐。您也可以从您喜欢的近期工作的例子开始，或者与您想要的东西类似的例子开始，询问是谁创作的，这样您已经对他们的能力和实力有了一个了解。
  </p>
  <p class="graf graf--p">
   在一开始就清楚地概述项目的范围和时间表，对于远程协作，这一点尤为重要。确保您还指定了作品的使用权和所有权，以及这些权利的期限。一些创意设计工作，如插图，将需要额外的费用，这取决于作品的发行格式和制作的数量。
  </p>
  <p class="graf graf--p">
   尽及时并经常给予反馈。尽量安排一个工作计划，定期检查和接受反馈。还要记住，您往往不是唯一的合作者 — — 询问您的合作对象的工作量，并考虑这将如何影响您的项目时间表。
  </p>
  <h2 class="graf graf--p">
   <span style="color: #339966;">
    <strong class="markup--strong markup--p-strong">
  ...
  <p class="graf graf--p">
   Witness 提供了很多视频制作技巧的资源。以下是7个部分的简述。
  </p>
  <figure class="graf graf--figure">
   <img class="graf-image aligncenter jetpack-lazy-image" data-height="534" data-image-id="0*iLkGDg81FdFl1vci.png" data-lazy-src="https://i1.wp.com/cdn-images-1.medium.com/max/1067/0*iLkGDg81FdFl1vci.png?w=1100&amp;is-pending-load=1#038;ssl=1" data-recalc-dims="1" data-width="780" src="https://i1.wp.com/cdn-images-1.medium.com/max/1067/0*iLkGDg81FdFl1vci.png?w=1100&amp;ssl=1" srcset="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"/>
   <noscript>
    <img class="graf-image aligncenter" data-height="534" data-image-id="0*iLkGDg81FdFl1vci.png" data-recalc-dims="1" data-width="780" src="https://i1.wp.com/cdn-images-1.medium.com/max/1067/0*iLkGDg81FdFl1vci.png?w=1100&amp;ssl=1"/>
   </noscript>
  </figure>
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
  ...
  <p class="graf graf--p">
   各国关于公民拍摄当局行为的法律各不相同。在您打开摄像机之前要了解您的权利。制定一个安全计划，以保护您的安全。记住紧急联系信息，或将其写在安全的地方。使用相机带或将相机绑在手腕上，以避免很容易被抢走。了解您的设备，不要携带借来的不够熟悉的设备进入危险的区域拍摄。如果您不能带着设备跑起来，就不要带它。
  </p>
  <p class="graf graf--p">
   开机 — —
  </p>
  <p class="graf graf--p">
   带上额外的充电电池和空的存储卡。如果使用智能手机拍摄，请关闭应用程序定位和wifi，并降低设备的屏幕亮度，以延长电池寿命。
  </p>
  <p class="graf graf--p">
   自行录制 — —
  </p>
  <p class="graf graf--p">
   对着摄像机说话，以确认您是拍摄者。或者，保留一份书面记录和原始视频文件。如果您出于安全考虑需要匿名，请使用一个代号。
  </p>
  <p class="graf graf--p">
   验证 — —
  </p>
  <p class="graf graf--p">
   如果您捕捉到拍摄这一镜头的日期、时间和位置，您的媒体内容更容易验证。如果可能的话，开启自动日期、时间和GPS位置捕捉功能。或者，拍摄当天的报纸、十字路口、路标和地标。
  </p>
  <p class="graf graf--p">
   稳定拍攝 — —
  </p>
  <p class="graf graf--p">
   保持拍摄至少10秒。保持相机稳定，改变位置时要非常缓慢地移动相机。避免剧烈运动和变焦。
  </p>
  <p class="graf graf--p">
   不同角度 — —
  </p>
  <p class="graf graf--p">
   通过广角和中景拍摄，使事件的背景更加清晰。使用特写镜头来捕捉细节。使用各种角度和仰角来捕捉人群的规模和行为。捕捉当局的存在和形成的镜头。如果要隐去身份，就从后面拍摄人群，只记录人们的后脑勺或脚。
  </p>
  <p class="graf graf--p">
   捕捉细节 — —
  </p>
  <p class="graf graf--p">
   在安全的情况下，记录逮捕或暴力事件的细节，拍摄参与人员的身份、周围的人群、受伤、弹孔或附近的车辆。在拍摄过程中，通过叙述事件的来龙去脉来记录细节。
  </p>
  <p class="graf graf--p">
   拍摄机构 — —
  </p>
  <p class="graf graf--p">
   在可能的情况下，拍摄或记录自己说出警员的姓名和警徽/警号。记录警察的一般行为，如警察接到的命令，或设置或移动路障。记录正在拍摄抗议活动的警察，以及当局持有或使用的任何武器。在这里看到镇压武器的详细介绍《
  ...
  <p class="graf graf--p">
   通过采访同意的抗议者或目击者提供更多细节。确保您拍摄的人完全了解视频的使用方式和发布地点。如果视频要公开、在线或与当局分享，要讨论潜在的安全风险。如果需要匿名，可以在受访者说话时拍下他们的手，让受访者用围巾包住脸，或者调整焦点以模糊画面。
  </p>
  <p class="graf graf--p">
   团队合作 — —
  </p>
  <p class="graf graf--p">
   ...
   帮忙保护您的安全，并观察记录重要情况。如果您的队友也有相机，尽量从不同角度拍摄同一事件。尽量让您的队友和您在彼此的视野中。如果您有被捕的风险，又想继续拍摄，可以考虑把存储卡交给队友保管，然后换成空卡。
  </p>
  <p class="graf graf--p">
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/po-FJzH3vUs" width="800">
   </iframe>
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
  ...
  <p class="graf graf--p">
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/qZnAYvbx_9g" width="800">
   </iframe>
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
  ...
  <p class="graf graf--p">
   倡导活动可能需要时间才能取得成果，因此，您的视频在拍摄后仍然可以长期使用这点是很重要的。此外，保持完整和真实的视频更值得信赖，在人权报告或法庭等情况下更可用。从长远来看，视频文件可以作为暴政和推翻暴政的过程的宝贵视觉历史记录。
  </p>
  <p class="graf graf--p">
   下面三段视频将帮助您开始工作。
  </p>
  <p class="graf graf--p">
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/9I3P0gI1BkM" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/Rm4O0w31uUY" width="800">
   </iframe>
  </p>
  <p class="graf graf--p">
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/A0g8JnuwiX8" width="800">
   </iframe>
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
  ...
  <p class="graf graf--p">
   以下是17个简短的视频，讲解了视频制作的基础知识，可帮助您创建推动变革的视频。
  </p>
  <p class="graf graf--p">
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/fuXPdbjrbfY?list=PL332C6188B7DFC351" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/B7BFnhYX2vs" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/r567vmL1Fcs" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/ps8Os0SIe_g" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/qXYEJDHIY-g" width="800">
   </iframe>
  </p>
  <p class="graf graf--p">
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/b3cPs6UWXgw" width="800">
   </iframe>
  </p>
  <p class="graf graf--p">
   <a class="markup--anchor markup--p-anchor" data-href="https://youtu.be/KTZoBDPCcsU" href="https://youtu.be/KTZoBDPCcsU" rel="nofollow noopener" target="_blank">
    <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/KTZoBDPCcsU" width="800">
    </iframe>
   </a>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/hZqcl6SKMyQ" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/ke303NkUAj8" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/29jU98J3hYw" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/uWpuI-SvUIY" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/3_Z52AFjFbw" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/dmih5Zp-Xd4" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/Zyj62hTG1B8" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/g3Z6QIGm_wQ" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/Up_PP0v2WdQ" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/bUuP00Y95DE" width="800">
   </iframe>
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
    <strong class="markup--strong markup--p-strong">
     5、在人权报告和倡导活动中使用视频的道德准则
    </strong>
   </span>
  </h3>
  <p class="graf graf--p">
   准则涵盖了人权文件的原则，讨论了如何利用这些原则来评估在网上分享虐待视频所涉及的各种风险，并提供了尽量减少这些风险的方法。准则涉及以下主题：
  </p>
  <ul class="postList">
   <li class="graf graf--li">
    考虑到拍摄者的同意、目标受众以及个人和社区的安全、尊严和隐私；
   </li>
   <li class="graf graf--li">
    在没有明确的知情同意指标的情况下，如何对使用录像是否会侵犯被拍摄者的同意、隐私或尊严作出专业判断，并权衡预期的社会利益和潜在的风险；
   </li>
   <li class="graf graf--li">
    尽可能在揭露虐待行为的同时减少伤害。报告虐待行为，但不分享录像，也不暴露出现在录像中的人的身份；
   </li>
   <li class="graf graf--li">
    设立关于拍摄者意图的问题清单，以评估分享录像所涉及的风险；
   </li>
   <li class="graf graf--li">
    向观众提及视频来源的三个理由  — — 对内容创作者的责任，对观众的透明度，以及追踪监管链；
   </li>
   <li class="graf graf--li">
    保护高危摄制者的安全或保持其匿名性的方法。
   </li>
   <li class="graf graf--li">
    图片素材：评估何时适合分享图片素材的问题清单。
   </li>
  </ul>
  <p class="graf graf--p">
   这份准则贯穿了世界各地的例子，说明了各种道德困境，以及活动家、新闻机构和人权组织解决这些困境的方法。
  </p>
  <p class="graf graf--p">
   <a class="markup--anchor markup--p-anchor" data-href="http://www.mediafire.com/download/pbahxdv48bi3m01/VaE_Ethical_Guidelines_v1_2.pdf" href="https://www.mediafire.com/download/pbahxdv48bi3m01/VaE_Ethical_Guidelines_v1_2.pdf" rel="noopener" target="_blank">
    在这里下载
   </a>
   这份准则。
  </p>
  ...
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/ox3D2uxFz0s" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/e1f2Prk1cSQ" width="800">
   </iframe>
  </p>
  <p>
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/Dgt1Zn6OKe4" width="800">
   </iframe>
  </p>
  <h3 class="graf graf--p">
   <span style="color: #ff99cc;">
  ...
  <p class="graf graf--p">
   <iframe allowfullscreen="allowfullscreen" height="449" src="//www.youtube.com/embed/GM-I5dnufIY" width="800">
   </iframe>
  </p>
  <p class="graf graf--p">
   就是这样。下一集中我们将介绍众包的信息行动主义项目方式，是的就像wiki，但不完全是为了完成一个项目而邀请更多人合作，信息行动主义不论采取那种工具，都是为基本战略服务的。下次见。⚪️
  </p>
  <p class="graf graf--p">
  ...
  <div id="atatags-1611829871-60c01fddc6adc">
  </div>
    ...
    <div class="sd-content">
     <ul>
      <li class="share-twitter">
       <a class="share-twitter sd-button share-icon no-text" data-shared="sharing-twitter-16250" href="https://www.iyouport.org/%e6%8c%91%e6%88%98%e5%bd%93%e6%9d%83%e8%80%85%e7%9a%84%e5%8f%99%e4%ba%8b%ef%bc%9a%e4%bf%a1%e6%81%af%e8%a1%8c%e5%8a%a8%e4%b8%bb%e4%b9%89%ef%bc%888%ef%bc%89-%e8%ae%b2%e8%bf%b0%e6%95%85%e4%ba%8b/?share=twitter" rel="nofollow noopener noreferrer" target="_blank" title="点击分享到Twitter">
        <span>
        </span>
      ...
      <li class="share-facebook">
       <a class="share-facebook sd-button share-icon no-text" data-shared="sharing-facebook-16250" href="https://www.iyouport.org/%e6%8c%91%e6%88%98%e5%bd%93%e6%9d%83%e8%80%85%e7%9a%84%e5%8f%99%e4%ba%8b%ef%bc%9a%e4%bf%a1%e6%81%af%e8%a1%8c%e5%8a%a8%e4%b8%bb%e4%b9%89%ef%bc%888%ef%bc%89-%e8%ae%b2%e8%bf%b0%e6%95%85%e4%ba%8b/?share=facebook" rel="nofollow noopener noreferrer" target="_blank" title="点击分享到 Facebook ">
        <span>
        </span>
        <span class="sharing-screen-reader-text">
  ...
  <div class="sharedaddy sd-block sd-like jetpack-likes-widget-wrapper jetpack-likes-widget-unloaded" data-name="like-post-frame-161182987-16250-60c01fddc73f1" data-src="https://widgets.wp.com/likes/#blog_id=161182987&amp;post_id=16250&amp;origin=www.iyouport.org&amp;obj_id=161182987-16250-60c01fddc73f1" id="like-post-wrapper-161182987-16250-60c01fddc73f1">
   <h3 class="sd-title">
    赞过：
   </h3>
 ...
 <div class="entry-footer">
  <ul class="post-tags light-text">
   ...
   <li>
    <a href="https://www.iyouport.org/tag/storytelling/" rel="tag">
     storytelling
    </a>
   </li>
   <li>
